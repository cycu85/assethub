 ...
 */
final class Version20250901062154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE aparatura_pomiarowa_equipment_set (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, set_type VARCHAR(100) DEFAULT NULL, status VARCHAR(50) NOT NULL, assigned_date DATE DEFAULT NULL, next_calibration_date DATE DEFAULT NULL, calibration_interval_months INT DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, notes LONGTEXT DEFAULT NULL, custom_fields JSON DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, attachments JSON DEFAULT NULL, assigned_to_id INT DEFAULT NULL, created_by_id INT NOT NULL, updated_by_id INT DEFAULT NULL, INDEX IDX_4B78482AF4BD7827 (assigned_to_id), INDEX IDX_4B78482AB03A8386 (created_by_id), INDEX IDX_4B78482A896DBBDE (updated_by_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
