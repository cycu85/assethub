...
class AparaturaPomiarowaReviewEquipmentRepository extends ServiceEntityRepository
{
    ...
    public function getResultStatistics(): array
    {
        ...
        $passed = (clone $qb)
            ...
            ->setParameter('passed', AparaturaPomiarowaReviewEquipment::RESULT_PASSED)
            ->getQuery()
            ->getSingleScalarResult();
        ...
        $failed = (clone $qb)
            ...
            ->setParameter('failed', AparaturaPomiarowaReviewEquipment::RESULT_FAILED)
            ->getQuery()
            ->getSingleScalarResult();
        ...
        $conditionallyPassed = (clone $qb)
            ...
            ->setParameter('conditionallyPassed', AparaturaPomiarowaReviewEquipment::RESULT_CONDITIONALLY_PASSED)
            ->getQuery()
            ->getSingleScalarResult();
