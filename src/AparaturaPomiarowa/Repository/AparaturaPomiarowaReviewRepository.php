...
class AparaturaPomiarowaReviewRepository extends ServiceEntityRepository
{
    ...
    public function findUpcomingReviews(int $days = 30): array
    {
        ...
        return $this->createQueryBuilder('r')
            ...
            ->setParameter('endDate', $endDate)
            ->setParameter('preparationStatus', AparaturaPomiarowaReview::STATUS_PREPARATION)
            ->orderBy('r.plannedDate', 'ASC')
            ->getQuery()
            ->getResult();
    }
    ...
    public function getActiveReviewsForEquipment(AparaturaPomiarowaEquipment $equipment): array
    {
        return $this->createQueryBuilder('r')
            ...
            ->setParameter('activeStatuses', [
                AparaturaPomiarowaReview::STATUS_PREPARATION,
                AparaturaPomiarowaReview::STATUS_SENT
            ])
            ->orderBy('r.createdAt', 'DESC')
            ->getQuery()
            ->getResult();
