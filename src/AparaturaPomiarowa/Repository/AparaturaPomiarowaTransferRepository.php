...
class AparaturaPomiarowaTransferRepository extends ServiceEntityRepository
{
    ...
    public function findActiveForUser(User $user): array
    {
        return $this->createQueryBuilder('t')
            ...
            ->setParameter('activeStatus', AparaturaPomiarowaTransfer::STATUS_ACTIVE)
    ...
    public function findGenerated(): array
    {
        return $this->createQueryBuilder('t')
            ->where('t.status = :status')
            ->setParameter('status', AparaturaPomiarowaTransfer::STATUS_GENERATED)
            ->orderBy('t.createdAt', 'DESC')
            ->getQuery()
            ->getResult();
    }
    ...
    public function findActive(): array
    {
        return $this->createQueryBuilder('t')
            ->where('t.status = :status')
            ->setParameter('status', AparaturaPomiarowaTransfer::STATUS_ACTIVE)
            ->orderBy('t.transferDate', 'ASC')
            ->getQuery()
            ->getResult();
    }
    ...
    public function findCompleted(): array
    {
        return $this->createQueryBuilder('t')
            ->where('t.status = :status')
            ->setParameter('status', AparaturaPomiarowaTransfer::STATUS_COMPLETED)
    ...
    public function findWithoutProtocolScan(): array
    {
        return $this->createQueryBuilder('t')
            ...
            ->setParameter('generatedStatus', AparaturaPomiarowaTransfer::STATUS_GENERATED)
            ->orderBy('t.createdAt', 'DESC')
            ->getQuery()
            ->getResult();
    }
    ...
    public function getActiveTransfersForEquipment(AparaturaPomiarowaEquipment $equipment): array
    {
        return $this->createQueryBuilder('t')
            ->where('t.equipment = :equipment')
            ...
            ->setParameter('activeStatuses', [
                AparaturaPomiarowaTransfer::STATUS_GENERATED,
                AparaturaPomiarowaTransfer::STATUS_ACTIVE
            ])
            ->orderBy('t.createdAt', 'DESC')
            ->getQuery()
            ->getResult();
    ...
    public function getActiveTransfersForEquipmentSet(AparaturaPomiarowaEquipmentSet $equipmentSet): array
    {
        return $this->createQueryBuilder('t')
            ->where('t.equipmentSet = :equipmentSet')
            ->andWhere('t.status IN (:activeStatuses)')
