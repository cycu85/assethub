...
class AparaturaPomiarowaEquipmentSetRepository extends ServiceEntityRepository
{
    ...
    {
        parent::__construct($registry, AparaturaPomiarowaEquipmentSet::class);
    }

    public function save(AparaturaPomiarowaEquipmentSet $entity, bool $flush = false): void
    {
    ...
    public function remove(AparaturaPomiarowaEquipmentSet $entity, bool $flush = false): void
    {
