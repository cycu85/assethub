...
/**
 * @extends ServiceEntityRepository<AparaturaPomiarowaEquipment>
 */
class AparaturaPomiarowaEquipmentRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, AparaturaPomiarowaEquipment::class);
    }

    public function save(AparaturaPomiarowaEquipment $entity, bool $flush = false): void
    {
    ...
    public function remove(AparaturaPomiarowaEquipment $entity, bool $flush = false): void
    {
    ...
    public function findAvailable(): array
    {
        return $this->createQueryBuilder('e')
            ...
            ->setParameter('status', AparaturaPomiarowaEquipment::STATUS_AVAILABLE)
            ->orderBy('e.name', 'ASC')
            ->getQuery()
            ->getResult();
    }
    ...
    public function findNeedingReview(): array
    {
        ...
        return $this->createQueryBuilder('e')
            ...
            ->setParameter('inReviewStatus', AparaturaPomiarowaEquipment::STATUS_IN_CALIBRATION)
    ...
    public function getStatistics(): array
    {
        ...
        $assigned = $this->createQueryBuilder('e')
            ->select('COUNT(e.id)')
            ->where('e.status = :status')
            ->setParameter('status', AparaturaPomiarowaEquipment::STATUS_ASSIGNED)
            ->getQuery()
            ->getSingleScalarResult();
        ...
        $inReview = $this->createQueryBuilder('e')
            ->select('COUNT(e.id)')
            ->where('e.status = :status')
            ->setParameter('status', AparaturaPomiarowaEquipment::STATUS_IN_CALIBRATION)
            ->getQuery()
            ->getSingleScalarResult();
        ...
        $damaged = $this->createQueryBuilder('e')
            ->select('COUNT(e.id)')
            ->where('e.status = :status')
            ->setParameter('status', AparaturaPomiarowaEquipment::STATUS_DAMAGED)
            ->getQuery()
            ->getSingleScalarResult();
    ...
    public function findByInventoryNumber(string $inventoryNumber): ?AparaturaPomiarowaEquipment
    {
        return $this->createQueryBuilder('e')
    ...
    public function getAllEquipmentSets(): array
    {
        return $this->getEntityManager()
            ->getRepository('App\AparaturaPomiarowa\Entity\AparaturaPomiarowaEquipmentSet')
