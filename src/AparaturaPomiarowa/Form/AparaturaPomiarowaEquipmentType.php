    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('name', TextType::class, [
                'label' => 'Nazwa mierniku',
                'attr' => [
                    'class' => 'form-control',
                    'placeholder' => 'np. Szelki robocze Petzl AVAO'
                ],
                'constraints' => [
                    new Assert\NotBlank(['message' => 'Nazwa mierniku jest wymagana']),
            ...
            ->add('description', TextareaType::class, [
                ...
                'attr' => [
                    'class' => 'form-control',
                    'rows' => 3,
                    'placeholder' => 'Szczegółowy opis mierniku, jego przeznaczenie, cechy charakterystyczne...'
                ]
            ])
            ...
            ->add('equipmentType', ChoiceType::class, [
                ...
                'placeholder' => 'Wybierz typ mierniku',
                'attr' => [
                    'class' => 'form-select'
                ],
                'constraints' => [
                    new Assert\NotBlank(['message' => 'Typ mierniku jest wymagany'])
                ]
            ])
            ...
            ->add('projekt', TextType::class, [
                ...
                'attr' => [
                    'class' => 'form-control',
                    'placeholder' => 'Nazwa projektu, w ramach którego zakupiono miernik'
                ]
            ])
            ...
            ->add('nextReviewDate', DateType::class, [
                ...
                'help' => 'Planowana data kolejnego kalibracjau okresowego'
            ])
            
            ->add('reviewIntervalMonths', IntegerType::class, [
                'label' => 'Okres kalibracjau (miesiące)',
                'required' => false,
                'attr' => [
                    'class' => 'form-control',
                    'min' => 1,
                ...
                'help' => 'Odstęp między kalibracjaami w miesiącach',
                'constraints' => [
                    new Assert\Positive(['message' => 'Okres kalibracjau musi być liczbą dodatnią']),
                    new Assert\Range(['min' => 1, 'max' => 120, 'notInRangeMessage' => 'Okres kalibracjau musi być między {{ min }} a {{ max }} miesiącami'])
                ]
            ])
