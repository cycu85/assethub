...
class AparaturaPomiarowaEventSubscriber
{
    ...
    private function sendEquipmentSetReviewNotification(AparaturaPomiarowaReview $review): void
    {
        ...
        // Pobierz elementy zestawu które będą w kalibracjazie
        $equipmentList = [];
    ...
    private function createEquipmentSetReviewNotification(AparaturaPomiarowaReview $review): void
    {
        $equipmentSet = $review->getEquipmentSet();
    ...
    private function createEquipmentReviewNotification(AparaturaPomiarowaReview $review): void
    {
