...
#[ORM\Entity(repositoryClass: AparaturaPomiarowaEquipmentRepository::class)]
#[ORM\HasLifecycleCallbacks]
#[ORM\Table(name: 'aparatura_pomiarowa_equipment')]
class AparaturaPomiarowaEquipment
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[Assert\NotBlank(message: 'Nazwa urządzenia jest wymagana')]
    ...
    #[Assert\NotBlank(message: 'Typ aparatury jest wymagany')]
    ...
    #[ORM\Column(type: Types::DATE_MUTABLE, nullable: true)]
    #[Assert\NotNull(message: 'Data następnej kalibracji jest wymagana')]
    ...
    #[ORM\OneToMany(mappedBy: 'equipment', targetEntity: AparaturaPomiarowaReview::class, cascade: ['persist'])]
    private Collection $reviews;

    #[ORM\OneToMany(mappedBy: 'equipment', targetEntity: AparaturaPomiarowaReviewEquipment::class, cascade: ['persist'])]
    private Collection $reviewEquipments;

    #[ORM\OneToMany(mappedBy: 'equipment', targetEntity: AparaturaPomiarowaTransfer::class, cascade: ['persist'])]
    private Collection $transfers;

    #[ORM\ManyToMany(targetEntity: AparaturaPomiarowaEquipmentSet::class, mappedBy: 'equipment')]
    ...
    public const STATUSES = [
        ...
        self::STATUS_IN_REVIEW => 'Na kalibracji',
    ...
    /**
     * @return Collection<int, AparaturaPomiarowaEquipmentSet>
     */
    ...
    public function addEquipmentSet(AparaturaPomiarowaEquipmentSet $equipmentSet): self
    {
    ...
    public function removeEquipmentSet(AparaturaPomiarowaEquipmentSet $equipmentSet): self
    {
     ...
     */
    public function getLastReviewEquipment(): ?AparaturaPomiarowaReviewEquipment
    {
        $reviewEquipments = $this->reviewEquipments->filter(function(AparaturaPomiarowaReviewEquipment $reviewEquipment) {
     ...
     */
    public function getPrimaryEquipmentSet(): ?AparaturaPomiarowaEquipmentSet
    {
