...
#[ORM\Entity(repositoryClass: AparaturaPomiarowaTransferRepository::class)]
#[ORM\HasLifecycleCallbacks]
#[ORM\Table(name: 'aparatura_pomiarowa_transfer')]
class AparaturaPomiarowaTransfer
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(targetEntity: AparaturaPomiarowaEquipment::class, inversedBy: 'transfers')]
    #[ORM\JoinColumn(nullable: true)]
    private ?AparaturaPomiarowaEquipment $equipment = null;

    #[ORM\ManyToOne(targetEntity: AparaturaPomiarowaEquipmentSet::class, inversedBy: 'transfers')]
    #[ORM\JoinColumn(nullable: true)]
    ...
    {
        $this->transferNumber = 'APM-TR-' . date('Y') . '-' . uniqid();
    }
    ...
    public function complete(User $returnedBy): self
    {
        ...
        if ($this->equipmentSet) {
            ...
            $this->equipmentSet->setStatus(AparaturaPomiarowaEquipmentSet::STATUS_ASSIGNED);
        }
    ...
    public function completeReturn(User $returnedBy, string $filename): self
    {
        ...
        if ($this->equipmentSet) {
            ...
            $this->equipmentSet->setStatus(AparaturaPomiarowaEquipmentSet::STATUS_AVAILABLE);
        }
