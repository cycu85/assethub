...
#[ORM\Entity(repositoryClass: AparaturaPomiarowaReviewRepository::class)]
#[ORM\HasLifecycleCallbacks]
#[ORM\Table(name: 'aparatura_pomiarowa_review')]
class AparaturaPomiarowaReview
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(targetEntity: AparaturaPomiarowaEquipment::class, inversedBy: 'reviews')]
    #[ORM\JoinColumn(nullable: true)]
    private ?AparaturaPomiarowaEquipment $equipment = null;

    #[ORM\ManyToOne(targetEntity: AparaturaPomiarowaEquipmentSet::class, inversedBy: 'reviews')]
    #[ORM\JoinColumn(nullable: true)]
    private ?AparaturaPomiarowaEquipmentSet $equipmentSet = null;
    ...
    #[ORM\OneToMany(mappedBy: 'review', targetEntity: AparaturaPomiarowaReviewEquipment::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
    ...
    public const STATUSES = [
        ...
        self::STATUS_SENT => 'Wysłane na kalibrację',
    ...
    {
        $this->reviewNumber = 'CAL-' . date('Y') . '-' . uniqid();
    }
    ...
    public function getEquipment(): ?AparaturaPomiarowaEquipment
    {
        return $this->equipment;
    }

    public function setEquipment(?AparaturaPomiarowaEquipment $equipment): self
    {
        $this->equipment = $equipment;
        return $this;
    }

    public function getEquipmentSet(): ?AparaturaPomiarowaEquipmentSet
    {
        return $this->equipmentSet;
    }

    public function setEquipmentSet(?AparaturaPomiarowaEquipmentSet $equipmentSet): self
    {
    ...
    {
        if (!$this->canBeSent()) {
            throw new \InvalidArgumentException('Kalibracja nie może być wysłana w aktualnym stanie');
        }
    ...
    public function completeReview(User $completedBy, ?string $result = null): self
    {
        if (!$this->canBeCompleted()) {
            throw new \InvalidArgumentException('Kalibracja nie może być zakończona w aktualnym stanie');
        }
    ...
    public function cancel(): self
    {
        if (!$this->canBeCancelled()) {
            throw new \InvalidArgumentException('Kalibracja nie może być anulowana w aktualnym stanie');
        }
    ...
    /**
     * @return Collection<int, AparaturaPomiarowaReviewEquipment>
     */
    ...
    public function addReviewEquipment(AparaturaPomiarowaReviewEquipment $reviewEquipment): self
    {
    ...
    public function removeReviewEquipment(AparaturaPomiarowaReviewEquipment $reviewEquipment): self
    {
    ...
    {
        return $this->reviewEquipments->map(function(AparaturaPomiarowaReviewEquipment $reviewEquipment) {
     ...
     */
    public function hasEquipmentInReview(AparaturaPomiarowaEquipment $equipment): bool
    {
    ...
    {
        return $this->reviewEquipments->filter(function(AparaturaPomiarowaReviewEquipment $reviewEquipment) {
