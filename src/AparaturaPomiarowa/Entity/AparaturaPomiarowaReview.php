...
class AparaturaPomiarowaReview
{
    ...
    private ?string $calibrationNumber = null;
    ...
    private ?string $calibrationLaboratory = null;
    ...
    {
        $this->calibrationNumber = 'CAL-' . date('Y') . '-' . uniqid();
    }
    ...
    public function getCalibrationType(): ?string
    {
        return $this->calibrationType;
    }

    public function setCalibrationType(?string $calibrationType): self
    {
