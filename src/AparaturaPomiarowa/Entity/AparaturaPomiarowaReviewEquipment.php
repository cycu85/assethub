...
#[ORM\Entity(repositoryClass: AparaturaPomiarowaReviewEquipmentRepository::class)]
#[ORM\HasLifecycleCallbacks]
#[ORM\Table(name: 'aparatura_pomiarowa_review_equipment')]
#[ORM\UniqueConstraint(name: 'unique_review_equipment', columns: ['review_id', 'equipment_id'])]
class AparaturaPomiarowaReviewEquipment
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(targetEntity: AparaturaPomiarowaReview::class, inversedBy: 'reviewEquipments')]
    #[ORM\JoinColumn(nullable: false, onDelete: 'CASCADE')]
    private ?AparaturaPomiarowaReview $review = null;

    #[ORM\ManyToOne(targetEntity: AparaturaPomiarowaEquipment::class, inversedBy: 'reviewEquipments')]
    ...
    private ?\DateTimeInterface $equipmentNextCalibrationDateAtReview = null;
    ...
    public function getReview(): ?AparaturaPomiarowaReview
    {
        return $this->review;
    }

    public function setReview(?AparaturaPomiarowaReview $review): self
    {
        $this->review = $review;
        return $this;
    }
    ...
    public function getEquipmentNextCalibrationDateAtReview(): ?\DateTimeInterface
    {
        return $this->equipmentNextCalibrationDateAtReview;
    }

    public function setEquipmentNextCalibrationDateAtReview(?\DateTimeInterface $equipmentNextCalibrationDateAtReview): self
    {
        $this->equipmentNextCalibrationDateAtReview = $equipmentNextCalibrationDateAtReview;
        return $this;
    }
     ...
     */
    public function captureEquipmentSnapshot(AparaturaPomiarowaEquipment $equipment): self
    {
        ...
        $this->equipmentNextCalibrationDateAtReview = $equipment->getNextReviewDate();
     ...
     */
    public function captureSetContext(AparaturaPomiarowaEquipmentSet $equipmentSet): self
    {
    ...
    public function getEffectiveResultDisplayName(): string
    {
        ...
        return AparaturaPomiarowaReview::RESULTS[$result] ?? $result ?? '';
    }
